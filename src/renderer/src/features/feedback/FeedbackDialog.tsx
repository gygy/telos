...
export function FeedbackDialog({ open, project, appInfo, onClose, onToast, onOpenExternal, onCreateSessionWithPrompt }: FeedbackDialogProps) {
	...
	const githubUrl = `https://github.com/gygy/telos/issues/new?title=${encodeURIComponent(issueTitle)}&body=${encodeURIComponent(feedback.text)}`;
							...
							<div className="flex min-h-0 flex-1 flex-col gap-3 p-4">
								...
								<div className="mt-auto flex flex-wrap items-center gap-2 border-t pt-3">
									...
									<Button
										variant="secondary"
										size="sm"
										onClick={() => onOpenExternal?.("https://github.com/gygy/telos")}
										disabled={!onOpenExternal}
									>
