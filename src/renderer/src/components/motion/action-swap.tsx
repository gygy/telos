"use client";
// Official BeUI sibling helper — beui.dev registry components/motion/action-swap
// 官方源码忠实拷贝（AgentDisclosure / ActionSwapRollText 的底层数字滚动/换字动画）。
// 2026-08 双轨收敛后的唯一实现（官方/定制双轨合并）。
