...
export const zhCN = {
  ...
  "config.dsh.archivedHint": "已归档的 DSH 会话（host 数据移入 DSH_HOME/.Telos-archive，可随时恢复；不销毁数据）。",
...
"config.proxyUrlUnset": "未配置代理 URL",
  ...
  "settings.storage.pasteFilesDesc": "输入框长文本转文件后落在应用数据目录；也会清理各项目遗留的 .Telos-paste",
  ...
  "settings.updateSourceDesc": "选择检测与下载更新使用的网络通道。默认使用 GitHub 官方 Release；AtomGit 为可选镜像（需仓库附件可用）。",
  "settings.updateSourceAtomGit": "AtomGit（可选镜像）",
  "settings.updateSourceGithub": "GitHub 官方（推荐）",
