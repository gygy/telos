...
export const enUS: Record<TranslationKey, string> = {
  ...
  "app.worktreeRemoveNotFound": "Git worktree not found. It may have been removed outside Telos.",
  ...
  "tabs.previewHint": "Preview “{name}”: send a message or double-click to pin. Closing the tab does not delete the session.",
  "tabs.placeholderNewSession": "New session",
  "tabs.placeholderNewSessionHint": "The session is created after you send the first message",
  ...
  "config.extensionWhitelistHint": "When extensions are disabled, Telos starts RPC with -e flags that load only enabled extensions. If an extension breaks startup, turn off the -e flag to let pi load all extensions by default.",
  ...
  "git.gitNotInstalledDesc": "Source control management requires Git. Please install Git from https://git-scm.com and restart Telos.",
  "browser.devicePC": "PC",
  ...
  "app.restoreSplit": "Show chat",
  "app.showChat": "Show chat",
  ...
  "app.logoLabel": "Telos logo",
  "app.homepage": "Website",
  "about.title": "About Telos",
  ...
  "app.modelListEmptyGuide": "No available models. Add a provider and models in Settings → Configuration → Models, then refresh.",
  ...
  "app.modelListFailConfigInvalid": "Model config files (models.json / auth.json) are malformed, so pi cannot read models. Fix the config in Settings → Configuration → Models (or rebuild a damaged file), then refresh.",
  ...
  "app.modelListFailEmpty": "No available models: neither the pi catalog nor the local models.json has models. Add a provider and models in Settings → Configuration → Models.",
  ...
  "app.preloadMissing": "Desktop preload API is not available. Restart Telos.",
  ...
  "app.emptyGuide": "Select a session from the left sidebar to start chatting, or click New session.\nYou can switch projects and history sessions in the sidebar.",
  ...
  "longTask.running": "Running. More input is queued and sent after this turn. Stopping keeps the queue; files can be restored from a checkpoint.",
  "longTask.runningQueued": "Running, with {n} queued. Stopping keeps those messages; files can be restored from a checkpoint.",
  "longTask.queued": "{n} queued. They send when the agent is idle. Stopping does not drop them.",
  "longTask.interrupted": "Stopped. Queued messages are still here — send again to continue. Open checkpoints to restore files.",
  "longTask.review": "Review",
  "longTask.checkpoint": "Checkpoints",
  "review.title": "Review",
  "review.hint": "This turn's changes and commands",
  "review.narrative": "Files and commands from this turn, in one place. The timeline is still the full trace; checkpoints restore files.",
  "review.files": "Files",
  "review.commands": "Commands",
  "review.empty": "Nothing to review this turn yet",
  "review.emptyHint": "File writes and commands show up here.",
  "review.noSession": "Open a session to review this turn",
  "review.noSessionHint": "File diffs, command excerpts, and the checkpoint entry land on this page.",
  "review.openCheckpoint": "Open checkpoints",
  "review.commandFailed": "Failed",
  ...
  "app.windowControls": "Telos window controls",
  ...
  "session.backendLockedBar": "{backend} session — create a new one to switch backends",
  ...
  "config.dsh.pluginClientCodeHint": "The Client half needs a dsh-web browser page, which Telos desktop does not render — fill in the Host half only.",
  ...
  "config.dsh.staticPluginsHint": "Loader entries in the current deployment cordis composition (multiple Loader entries of the same module are merged into one row). The origin badge distinguishes \"Built-in\" (dsh base / shipped presets / Telos composition) from \"User installed\" (the $DSH_HOME/cordis.patch.yml user patch layer). User-installed entries can be uninstalled in place (the patch file is backed up before the row is removed; plugin folders inside Telos's managed directory are moved to the recycle bin as well) and take effect after a DSH host restart.",
  ...
  "config.dsh.pluginFilesKeepHint": "Removed from the user patch layer; plugin files live outside Telos's managed folder — delete them manually if needed",
  ...
  "dsh.runtime.managedHint": "Downloaded on demand into the app data directory; can be uninstalled. Upgrading DSH does not require reinstalling Telos.",
  ...
  "dsh.runtime.outdatedDesc": "The installed runtime is v{installed}, but this Telos version pairs with v{declared}. To avoid protocol incompatibilities, DSH has been disabled. Please reinstall the matching runtime.",
  "dsh.runtime.sendOutdated": "The DSH backend runtime (v{installed}) does not match this Telos version (pairs with v{declared}) and has been disabled. Reinstall it from the configuration page before sending.",
  ...
  "config.tokendance.keyDesc":
    "Model requests are billed to your TokenDance account and need an API Key. Paste an existing one, or create one via the authorization page (attributed to Telos).",
  ...
  "config.tokendance.waitingBrowser": "Opened the authorization page in your browser: once you sign in, Telos captures the API Key automatically and writes the config — nothing to copy.",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "editors.hint": "Manage external editors shown in the project menu. Telos detects them asynchronously on first launch, and paths can be edited manually.",
  ...
  "config.recommendedPackagesHint": "These extensions are compatible with Telos. Some CLI-specific features (e.g. TUI) may not apply in the desktop version.",
  ...
  "config.extRecommended.piDeckTodo": "Built into Telos: a current-plan TODO extension with explicit replace and restore actions, branch-scoped persistence, and task-progress tracking.",
  "config.extRecommended.piDeckPlanMode": "Built into Telos: a plan-mode extension that makes the AI produce an execution plan before replying, keeping complex tasks clear.",
  "config.extRecommended.piDeckGoalMode": "Built into Telos: a goal-mode extension that keeps working toward one objective until it is complete, blocked, or paused.",
  "config.extRecommended.piDeckAskQuestion": "Built into Telos: inserts carefully designed question cards into conversations to guide the AI toward more precise answers.",
  "config.extRecommended.piDeckNulRedirectFix": "Built into Telos: fixes leftover file issues when pi redirects to the NUL device on Windows.",
...
"config.proxyUrlUnset": "No proxy URL configured",
  ...
  "config.im.guideMethodAStep3": "Fill in the credentials in Telos and connect",
  ...
  "config.im.guideMethodBStep6": "Get App ID and App Secret from 'Credentials & Basic Info', fill in Telos",
  ...
  "feedback.report.piDesktop": "- Telos: {value}",
  ...
  "drawer.sessionEmptyDesc":
    "Right-click a project in the sidebar to open history. Completed sessions will appear here.",
  ...
  "settings.vision.configFileDesc": "The extension and Telos share this file: it also works when editing manually with pi outside Telos.",
  ...
  "settings.backup.desc": "Snapshot model config, pi settings and Telos settings. One initial backup is created automatically on first use; after that backups are manual only. Back up or restore anytime to recover from misconfiguration or loss.",
  "settings.backup.createButton": "Back Up Now",
  "settings.backup.createDesc": "Save current model config, pi settings and Telos settings as one snapshot",
  ...
  "usageStats.notInstalled.backfill": "The plugin only records conversations after installation. To backfill historical usage, run /analytics import in a pi terminal or in an agent started by Telos",
  ...
  "settings.electronSandboxDesc": "Controls Electron renderer sandbox (unrelated to pi Agent). Off by default for Windows AV/GPU compatibility. Requires restarting Telos. Turn it back off if the app fails to start.",
  ...
  "settings.shellContextMenuSectionDesc": "Adds an \"Open with Telos\" entry to the Windows folder context menu for the current user (writes to the user registry; works with the portable build too).",
  "settings.shellContextMenu": "Open a project from the folder context menu",
  "settings.shellContextMenuDesc": "Adds \"Open with Telos\" to the context menu of folders (and Explorer background): known directories jump straight to their project; unknown ones first ask to be added as a project.",
  ...
  "settings.updateInstalling": "Closing Telos to install v{version}...",
  ...
  "settings.macManualUpdateDesc": "This macOS build is not signed with an Apple Developer ID, so Telos checks for updates and opens the Release page for manual installation.",
  ...
  "app.updateCardVersion": "Telos v{version}",
  ...
  "settings.dshRunnerNodeSourceSidecar": "Telos private copy",
  ...
  "settings.dshRunnerNodeCoexistHint": "PATH can stay on another Node. nvm/fnm users should pick node.exe inside a v24.x folder, not the current shim. One-click download uses the app update source (AtomGit/GitHub) and writes only to Telos’s data directory.",
...
"settings.piProxyModelsNoModelHint": "Add models via Pi Manager → Models to configure proxy for them",
  ...
  "settings.wsl.apiUnavailable": "The WSL API is not ready. Restart Telos and try again.",
  ...
  "settings.restartApp": "Restart Telos",
  ...
  "settings.restartNotice":
    "Title bar changes take effect after restarting Telos.",
  ...
  "settings.updateInstallUnsavedMessage": "Restarting to install the update will close Telos. Save your changes first, or explicitly discard them.",
  ...
  "settings.webQrDesc": "Scan this code with your phone to open Telos Web",
  ...
  "settings.webQrAlt": "Telos Web service QR code",
  ...
  "update.readyToInstall": "Telos v{version} has been downloaded. Restart to install.",
  ...
  "update.saveBeforeInstallDetail": "Telos could not save every open file change. Resolve the editor error, then try again.",
  ...
  "update.availableToast": "Telos v{version} is available. Download it in Settings.",
  "update.availableManualToast": "Telos v{version} is available. Download and install it manually from the Release page.",
  "update.dotMenuTitle": "Updates available",
  "update.dotMenuApp": "Telos v{version}",
  "update.dotMenuPi": "pi CLI v{version}",
  "update.dotMenuCatalog": "Model catalog v{version}",
  "update.dotHintTitle": "Updates available",
  "update.dotHintBody": "The dot on the Settings button means updates are available (Telos app / pi CLI / model catalog).",
