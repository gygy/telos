...
export const enUS: Record<TranslationKey, string> = {
  ...
  "config.dsh.archivedHint": "Archived DSH sessions (host data moved to DSH_HOME/.Telos-archive; restorable at any time, never deleted).",
...
"config.proxyUrlUnset": "No proxy URL configured",
  ...
  "settings.storage.pasteFilesDesc": "Long composer pastes are saved under the app data directory; leftover project .Telos-paste folders are cleared too",
  ...
  "settings.updateSourceDesc": "Choose the network channel for checking and downloading updates. GitHub Releases is the default; AtomGit is an optional mirror when available.",
  "settings.updateSourceAtomGit": "AtomGit (optional mirror)",
  "settings.updateSourceGithub": "GitHub Official (Recommended)",
