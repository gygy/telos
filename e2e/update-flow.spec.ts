...
// Packaged verification sets PIDEK_E2E_EXECUTABLE_PATH, so use Telos's package version instead.
...
const UPDATE_BYTES = Buffer.from("Telos electron-updater E2E fixture payload\n", "utf8");
