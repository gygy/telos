...
Telos provides visual configuration management for all its settings.
...
Skills extend the agent's capabilities. Telos supports two levels:
...
Extensions add new functionality to Telos itself (not the agent). Manage them in the Extensions tab:
