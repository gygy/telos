...
> This handbook walks through every feature of Telos by UI area: where each button, menu, context menu, and shortcut lives, how to use it, and what it does.
...
- **Tabs**: `+` new (defaults to the Telos home page), click to switch, `×` to close; tab state survives drawer/fullscreen toggles.
