...
function ModelsSectionContent(
  ...
  /** HTTP User-Agent for proxy providers; default TelosDesktop/{appVersion}. */
  const [userAgent, setUserAgent] = useState("TelosDesktop/0.0.0");
    ...
    void window.pix.app
      ...
      .then((runtime) => {
        ...
        setUserAgent((current) =>
          !current || current === "TelosDesktop/0.0.0" ? `TelosDesktop/${v}` : current,
        );
      })
      .catch(() => {
